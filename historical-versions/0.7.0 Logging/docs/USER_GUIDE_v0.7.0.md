...
| `/access` | Remote access URL via Tailscale (v0.7.0) |
| `/help` | Full help |
...
1. Install Tailscale on your phone/laptop (same account)
2. Use `/access` command in Telegram to get the URL
3. Navigate to `http://<tailscale-ip>:5000`

**Why Tailscale?**
- **Easiest**: ~5 minute setup, no port forwarding
- **Secure**: Traffic encrypted, never exposed to public internet
- **Free**: Personal use up to 100 devices
- **Privacy-aligned**: Peer-to-peer when possible, no data through third parties
