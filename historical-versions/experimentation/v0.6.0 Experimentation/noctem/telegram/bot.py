...
def create_bot() -> Application:
    ...
    # AI commands (v0.6.0)
    app.add_handler(CommandHandler("nextaction", handlers.cmd_nextaction))
    app.add_handler(CommandHandler("aistatus", handlers.cmd_aistatus))
    app.add_handler(CommandHandler("aisettings", handlers.cmd_aisettings))
